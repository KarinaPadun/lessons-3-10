...
####################### ООП ############### - обектно орієнтовно програмування , стиль написання коду

# class -це структура данних Б яка виступає обектом, в який можна скласти методи та функції

# class Person:    # класи з великої букви , кожне наступне слово з великої
#     name = None   # атрибут класу - з чого складаються , те що лежить за замовчанням
#     age = 0
#
#
...
#
# person_1.name = "Nick"
# # person_1.age = 24  # атрибут екзампляру класу - те що лежить в екземплярі класу
#
# print(person_1.name)
# print(person_1.age)