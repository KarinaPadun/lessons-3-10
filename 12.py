...
class Trader:
    ...
    def buy(self, amount):
        required_balance = amount * self.rate
        if self.uah_balance < required_balance:
            print(f"UNAVAILABLE, REQUIRED BALANCE UAH {required_balance:.2f}, AVAILABLE {self.uah_balance:.2f}")
            return
        self.uah_balance -= required_balance
...
def main():
    ...
    if args.command == "RATE":
        ...
        print(f"Received UAH: {uah_amount}")
