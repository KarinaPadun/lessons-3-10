...
# Оновлюємо інформацію про директорію, додаючи новий файл
updated_info_file = update_directory_info(directory_info, 'new_file.txt')
print("\nОновлена інформація (додавши файл):", updated_info_file)

# Оновлюємо інформацію про директорію, додаючи нову папку
updated_info_dir = update_directory_info(updated_info_file, 'new_directory')
print("\nОновлена інформація (додавши папку):", updated_info_dir)
